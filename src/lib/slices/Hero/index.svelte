	...
	<div class="mx-auto w-full max-w-7xl">
		...
		<div class="grid min-h-[65vh] grid-cols-1 items-center md:grid-cols-2">
			...
			<div class="col-start-1 md:row-start-1">
				<h1 class="mb-2 md:mb-4 text-[clamp(3rem,20vmin,13rem)] font-extrabold leading-none tracking-tight text-nowrap" aria-label={slice.primary.first_name + ' ' + slice.primary.last_name}>
				...
				<span class="job-title block bg-gradient-to-tr from-slate-500 via bg-slate-200 to-slate-500 bg-clip-text text-transparent text-2xl font-bold uppercase tracking-[.2em] md:text-4xl opacity-0">
